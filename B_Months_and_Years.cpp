...
void solve()
{
    ll n;
    cin>>n;
    string s="312831303130313130313031312931303130313130313031312831303130313130313031312831303130313130313031";
    string ss;
    for(int i=0;i<n;i++){
        ll x;
        cin>>x;
        ss.append(to_string(x));
    }
    if(s.find(ss)!=std::string::npos) py;
    else pn;
