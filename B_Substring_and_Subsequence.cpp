...
int longestSubstringInBAsSubsequence(const std::string& A, const std::string& Bb) {
    int n = A.length();
    int m = Bb.length();
    
    // Create a 2D vector to store the longest substring lengths
...
void solve()
{
    ...
    ll sss=longestSubstringInBAsSubsequence(s2,s1);
    cout<<n + m - sss<<endl;
}
